...
#include "Prototype/Public/BloqueRandom.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeBloqueRandom() {}

// Begin Cross Module References
PROTOTYPE_API UClass* Z_Construct_UClass_ABloque();
PROTOTYPE_API UClass* Z_Construct_UClass_ABloqueRandom();
PROTOTYPE_API UClass* Z_Construct_UClass_ABloqueRandom_NoRegister();
...
template<> PROTOTYPE_API UClass* StaticClass<ABloqueRandom>()
{
	return ABloqueRandom::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Prototype_Source_Prototype_Public_BloqueRandom_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABloqueRandom, ABloqueRandom::StaticClass, TEXT("ABloqueRandom"), &Z_Registration_Info_UClass_ABloqueRandom, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABloqueRandom), 1862111409U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Prototype_Source_Prototype_Public_BloqueRandom_h_1231661869(TEXT("/Script/Prototype"),
	Z_CompiledInDeferFile_FID_Prototype_Source_Prototype_Public_BloqueRandom_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Prototype_Source_Prototype_Public_BloqueRandom_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
